...
async function imageShortcode(src, alt, sizes = "100vw") {
  ...
  let metadata = await Image(src, {
    ...
    outputDir: './public/content/images/' // passthrough below didn't work, write to output dir by now
...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy("public/"); // path is relative from root
  ...
  eleventyConfig.addWatchTarget("./src/includes/assets"); // normal (static) assets
  eleventyConfig.addWatchTarget("./public") // laravel-mix output changes
  ...
  return {
    dir: {
      ...
      layouts: "includes/templates", // this path is releative to input-path (src/)
